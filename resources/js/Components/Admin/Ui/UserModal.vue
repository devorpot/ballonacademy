        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <div class="form-check mb-2">
              ...
              >
              <label for="select_all_roles" class="form-check-label fw-bold">
              ...
              <div class="col-md-6" v-for="role in roles" :key="role.id">
                <div class="form-check mb-1">
                  <input
                    ...
                    @change="handleRoleChange"
                  >
                  <label :for="'role_' + role.id" class="form-check-label">{{ role.label }}</label>
                </div>
              </div>
            </div>

            <div class="text-danger mt-2" v-if="(touched.role_ids && validateRoles()) || form.errors.role_ids || form.errors.role">
