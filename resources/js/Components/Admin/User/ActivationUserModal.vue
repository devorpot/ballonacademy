        ...
        <form @submit.prevent="submit">
          <div class="modal-body">
            <div class="mb-3">
              ...
              <small class="text-muted">Debe ser un correo que no pertenezca a ningún usuario registrado.</small>
            </div>

            <div class="mb-3 form-check form-switch">
              <input class="form-check-input" type="checkbox" id="assign_password" v-model="form.assign_password" />
              <label class="form-check-label" for="assign_password">Asignar password manualmente</label>
            </div>
...
const props = defineProps({
  ...
  user: { type: Object, required: true } // { id, email }
})
