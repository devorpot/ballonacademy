...
// Devuelve fecha formateada o el día actual
...
const form = useForm({
  ...
  image_cover: props.course.image_cover,
  logo: props.course.logo,
  date_start: formatDate(props.course.date_start),
  date_end: formatDate(props.course.date_end)
});
