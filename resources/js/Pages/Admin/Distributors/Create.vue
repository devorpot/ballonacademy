<template>
  <Head title="Crear Nuevo Distribuidor" />
  <AdminLayout>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    <FieldSelect
                      ...
                      :validateFunction="() => validateRequired('country', 'El campo state es obligatorio')"
                      :options="stateOptions"
                      @blur="() => handleBlur('state')"
                    />
                  </div>

                  <!-- State (enum de países América/Europa) -->
                  <div class="col-md-6 mb-3">
                    <FieldText
                      id="state"
                      label="Estado"
...
const props = defineProps({
  countries: { type: Array, default: () => [] } // proveniente del controlador
})
...
const isFormValid = computed(() => {
  return !validateRequired('name', 'El nombre es obligatorio') &&
         ...
         !validateRequired('state', 'El campo state es obligatorio') &&
         !validateRequired('address', 'La dirección es obligatoria')
})

const submit = () => {
  // Marcar como tocados los campos importantes
  ;['name','country','state','address'].forEach(k => touched.value[k] = true)
...
<style scoped>
/* Opcional: mismo overlay suave que usas en otras vistas */
</style>
