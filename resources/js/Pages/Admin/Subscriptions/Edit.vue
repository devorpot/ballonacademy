                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      <FieldText
                        ...
                        placeholder="Ingrese el ID de Stripe"
                        :readonly="true"
                    ...
                    <div class="col-md-6 mb-3" v-if="form.payment_refund">
...
payment_refund: props.subscription.payment_refund === true || props.subscription.payment_refund === 1 || props.subscription.payment_refund === '1',
...
used_coupon: props.subscription.used_coupon === true || props.subscription.used_coupon === 1 || props.subscription.used_coupon === '1',
...
const originalAmount = ref(parseFloat(props.subscription.payment_amount || 0));
...
const validateField = (field) => {
  ...
  if (field === 'coupon_discount' && form.used_coupon) {
    ...
    if (discount > base) {
      return 'El descuento no puede ser mayor al monto original';
    }
  }
...
const isFormValid = computed(() => {
  return !validateField('user_id') &&
         ...
         !validateField('payment_stripe_id') &&
...
watch([
  ...
  if (form.used_coupon && !isNaN(discount)) {
    const discounted = Math.max(0, base - discount);
    form.payment_amount = discounted.toFixed(2);
  } else {
    form.payment_amount = base.toFixed(2); // ⬅️ restaurar monto original
  }
});
